...
export const practiceSites = [
  {
    ...
    videos: [
      ...
      createNjuBoxVideo({
        id: 'wutang-vlog',
        title: '五塘小学 vlog',
        filePath: '/五塘小学修改版.mp4',
        shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
      }),
    ],
  ...
  },
  {
    ...
    videos: [
      ...[1, 2, 3, 4].map((part) => createNjuBoxVideo({
  ...
  },
  {
    ...
    videos: [createNjuBoxVideo({
      id: 'xiaozhuang-vlog',
      title: '晓庄小学 vlog',
      filePath: '/晓庄小学vlog（修改版）/晓庄小学vlog（修改版）.mp4',
      shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
    })],
  ...
  },
  {
    ...
    videos: [
      ...
      createNjuBoxVideo({
        id: 'xiaozhuangshiyan-vlog',
        title: '南京晓庄实验学校 vlog',
        filePath: '/南京晓庄实验学校.mp4',
        shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
      }),
    ],
  ...
  },
  {
    ...
    videos: [
      ...
      createNjuBoxVideo({
        id: 'xiaozhuangfushu-vlog',
        title: '晓庄附属小学 vlog',
        filePath: '/南京晓庄学院附属小学.mp4',
        shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
      }),
    ],
  ...
  },
  {
    ...
    videos: [
      ...
      createNjuBoxVideo({
        id: 'chongqing-yucai-vlog',
        title: '重庆育才中学 vlog',
        filePath: '/重庆站（修改版）.mp4',
        shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
      }),
    ],
  ...
  },
  {
    ...
    practices: [],
    gallery: [
      { id: 'gushengsi-campus-01', src: 'media/gushengsi/photos/campus-01.webp', srcSet: ['media/gushengsi/photos/campus-01-768.webp 768w', 'media/gushengsi/photos/campus-01-1280.webp 1280w'], alt: '合川古圣寺旧址环境实景', caption: '旧址实景', credit: '行知溯光实践团队', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
      { id: 'gushengsi-archive-01', src: 'media/gushengsi/photos/campus-02.webp', srcSet: ['media/gushengsi/photos/campus-02-768.webp 768w', 'media/gushengsi/photos/campus-02-1280.webp 1280w'], alt: '合川古圣寺旧址历史档案展板', caption: '历史档案', credit: '历史档案图片（行知溯光实践团队翻拍自古圣寺旧址陈列）', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
      { id: 'gushengsi-archive-02', src: 'media/gushengsi/photos/campus-03.webp', srcSet: ['media/gushengsi/photos/campus-03-768.webp 768w', 'media/gushengsi/photos/campus-03-1280.webp 1280w'], alt: '合川古圣寺旧址历史档案展板', caption: '历史档案', credit: '历史档案图片（行知溯光实践团队翻拍自古圣寺旧址陈列）', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
      { id: 'gushengsi-campus-02', src: 'media/gushengsi/photos/campus-04.webp', srcSet: ['media/gushengsi/photos/campus-04-768.webp 768w', 'media/gushengsi/photos/campus-04-1280.webp 1280w'], alt: '合川古圣寺旧址环境实景', caption: '旧址实景', credit: '行知溯光实践团队', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
      { id: 'gushengsi-campus-03', src: 'media/gushengsi/photos/campus-05.webp', srcSet: ['media/gushengsi/photos/campus-05-768.webp 768w', 'media/gushengsi/photos/campus-05-1280.webp 1280w'], alt: '合川古圣寺旧址环境实景', caption: '旧址实景', credit: '行知溯光实践团队', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
      { id: 'gushengsi-campus-04', src: 'media/gushengsi/photos/campus-06.webp', srcSet: ['media/gushengsi/photos/campus-06-768.webp 768w', 'media/gushengsi/photos/campus-06-1280.webp 1280w'], alt: '合川古圣寺旧址环境实景', caption: '旧址实景', credit: '行知溯光实践团队', sourceUrl: '', width: 1600, height: 1200, publishStatus: published },
    ],
    videos: [],
  ...
  },
  {
    ...
    videos: [
      ...
      createNjuBoxVideo({
        id: 'huai-an-xin-an-vlog',
        title: '淮安新安小学 vlog',
        filePath: '/淮安vlog/淮安vlog.mp4',
        shareUrl: 'https://box.nju.edu.cn/d/20bed9981608456d9924/',
      }),
    ],
  ...
  },
  {
    ...
    practices: [],
    gallery: [
      { id: 'hangzhou-xianghu-quote', src: 'media/hangzhou-xianghu/photos/campus-01.webp', alt: '杭州湘湖师范校园内的陶行知题词"捧着一颗心来"', caption: '捧着一颗心来', credit: '行知溯光实践团队', width: 1600, height: 900, publishStatus: published },
      { id: 'hangzhou-xianghu-library', src: 'media/hangzhou-xianghu/photos/campus-02.webp', alt: '杭州湘湖师范图书馆外观', caption: '图书馆外观', credit: '行知溯光实践团队', width: 1600, height: 900, publishStatus: published },
      { id: 'hangzhou-xianghu-zhixing', src: 'media/hangzhou-xianghu/photos/campus-03.webp', alt: '杭州湘湖师范"知行"石刻', caption: '知行', credit: '行知溯光实践团队', width: 1600, height: 900, publishStatus: published },
      { id: 'hangzhou-xianghu-sculpture-01', src: 'media/hangzhou-xianghu/photos/campus-04.webp', alt: '杭州湘湖师范雕像墙', caption: '雕像墙', credit: '行知溯光实践团队', width: 1600, height: 900, publishStatus: published },
...
export const academyHeritageEntries = [
  ...
  {
    id: '2025-yang-rui-qing-interview',
    year: '2025',
    period: '暑期实践 · 第二站',
    sequence: 2,
    category: '教育理念访谈',
    title: '专访行知教育集团总校长杨瑞清',
    summary:
      '"行知溯光"暑期社会实践团队走进南京行知基地，聆听杨瑞清校长讲述行知教育四十余年发展历程与以"爱"为核心的教育理念，深入体悟行知精神的传承与实践。',
    image: {
      src: 'media/heritage/2025-yang-rui-qing-cover.jpg',
      alt: '行知教育集团总校长杨瑞清先生接受访谈时的现场照片',
      width: 853,
      height: 853,
      focalPoint: '50% 30%',
      credit: '南京大学行知书院微信公众号',
    },
    url: 'https://mp.weixin.qq.com/s/-yZoBWCFeBuuMlDBv5ZcJQ',
    sourceLabel: '南京大学行知书院',
    publishStatus: published,
  },
  {
